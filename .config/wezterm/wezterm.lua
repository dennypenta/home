...
return {
	-- keys
	leader = { key = "Tab", timeout_milliseconds = 1000 },
	keys = {
		...
		{ key = "-", mods = "LEADER", action = wezterm.action.AdjustPaneSize({ "Left", 4 }) },
		{ key = "=", mods = "LEADER", action = wezterm.action.AdjustPaneSize({ "Right", 4 }) },
		{ key = "+", mods = "LEADER", action = wezterm.action.AdjustPaneSize({ "Down", 4 }) },
		{ key = "_", mods = "LEADER", action = wezterm.action.AdjustPaneSize({ "Up", 4 }) },
