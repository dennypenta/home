...
return {
  ...
  opts = function(_, opts)
    ...
    config.defaults.keymap.builtin["<c-p>"] = "preview-page-up"
  ...
  keys = {
    ...
    { "<c-n>", "<c-n>", ft = "fzf", mode = "t", nowait = true, desc = "Scroll down fzf preview" },
    { "<c-p>", "<c-p>", ft = "fzf", mode = "t", nowait = true, desc = "Scroll up fzf preview" },
    {
      "<leader>,",
